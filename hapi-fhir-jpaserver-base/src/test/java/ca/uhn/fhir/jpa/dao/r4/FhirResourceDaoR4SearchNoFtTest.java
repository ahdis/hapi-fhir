...
// FIXME				assertThat("Failed to load range " + i + " - " + (i + 1), resources, hasSize(1));
...
//		assertEquals(searchQuery, 2, StringUtils.countMatches(searchQuery.toUpperCase(), "AND RESOURCETA0_.RES_UPDATED"));
	...
	@Test
	public void testDateSearchParametersShouldBeTimezoneIndependent() throws FHIRException {
	...
	private void createObservationWithEffective(String theId, String theEffective) throws FHIRException {
		Observation obs = new Observation();
		obs.setId(theId);
